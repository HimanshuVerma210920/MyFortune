...
<body>
	<div class="content">
		<h2 class="h2">Lumpsum Calculator</h2>
	</div>  
</body>
</html>
<?php
    ...
    $i = (1+$i)**$n;
    $a = $p*$i;
    echo "<h2>Your Total Returns :",floor($a),"</h2>";
    $d = $a-$p;
    $ratio1 = ceil(($d/$a)*100);
    $ratio2 = ceil(100-$ratio1);
?>	
						...
						<div class="container">
							<div class="row">
								<div class="col-xs-12 col-sm-6 col-md-3">
									<div class="skill-item center-block">
										<div class="chart-container">
											...
											<div class="chart " data-percent="<?php echo $ratio2 ?>" data-bar-color="#23afe3">
												<span class="percent" data-after="%"><?php echo $ratio2 ?></span>
											</div>
											
										</div>

										<p>Investment : <?php echo ceil($p) ?></p>
									</div>
								</div>
								...
								<div class="col-xs-12 col-sm-6 col-md-3">
									<div class="skill-item center-block">
										<div class="chart-container">
											<div class="chart " data-percent="<?php echo $ratio1 ?>" data-bar-color="#a7d212">
												<span class="percent" data-after="%"><?php echo $ratio1 ?></span>
											</div>
										</div>

										<p>Returns : <?php echo ceil($d) ?></p>
									</div>
								</div>
